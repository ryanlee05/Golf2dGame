...
public class Player extends Entity {
	...
	public void getPlayerImage() {
		try {
			...
			setDriver = ImageIO.read(getClass().getResourceAsStream("/player/player_driver.png"));
			setIron = ImageIO.read(getClass().getResourceAsStream("/player/player_iron.png"));
			setWedge = ImageIO.read(getClass().getResourceAsStream("/player/player_wedge.png"));
			setPutter = ImageIO.read(getClass().getResourceAsStream("/player/player_putter.png"));
			bsDriver = ImageIO.read(getClass().getResourceAsStream("/player/bs_driver.png"));

			bsIron = ImageIO.read(getClass().getResourceAsStream("/player/bs_iron.png"));

			bsWedge = ImageIO.read(getClass().getResourceAsStream("/player/bs_wedge.png"));

			bsPutter = ImageIO.read(getClass().getResourceAsStream("/player/bs_Putter.png"));
			// bsWedge
			// bsPutter
			// finishDriver
			// finishIron
